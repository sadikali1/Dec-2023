...
public class StepsDef2 {
	...
	public void verify_all_menus_option(DataTable table) {
		/*
		 * List<List<String>> datas = table.asLists(); for(List<String> data : datas){
		 * System.out.println(data.get(0)); Assert.assertTrue(Hooks.driver.findElement(
		 * By.xpath("//*[@class=\"oxd-main-menu-item-wrapper\"]/a/span[text()='"+data.
		 * get(0)+"']")).isDisplayed()); }
		 */
